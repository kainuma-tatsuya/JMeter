...
public class EncoderCache {
    ...
    public String getEncoded(String k, String contentEncoding) throws UnsupportedEncodingException {
        ...
        //XXX encodedValue = URLEncoder.encode(k, contentEncoding);
	  URLCodec codec = new URLCodec(contentEncoding); //XXX
	  try { encodedValue = codec.encode(k); } catch (Exception e) { e.printStackTrace(); } //XXX
        // Add to cache
