...
public class ProxyControlGui extends LogicControllerGui implements JMeterGUIComponent, ActionListener, ItemListener,
    ...
    public void actionPerformed(ActionEvent action) {
        ...
        if (command.equals(ACTION_STOP)) {
            ...
            excludeModel.fireTableDataChanged();
            enableRestart();
        } else if (command.equals("defaultEncoding")) { //XXX
            model.setDefaultEncoding(defaultEncoding.getText()); //XXX
  		log.debug("setDefaultEncoding: {}", model.getDefaultEncoding()); //XXX
        }
    }
    ...
    private JPanel createHTTPSamplerPanel() {
        ...
        defaultEncoding.addActionListener(this);//XXX
        defaultEncoding.setActionCommand("defaultEncoding");//XXX
